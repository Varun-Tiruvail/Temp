...
#             approvals = get_pending_approvals()  # All pending
#             self.setWindowTitle('Pending Approvals (Superuser View)')
#         else:
#             approvals = get_pending_approvals(self.current_user)
#             self.setWindowTitle(f'Pending Approvals for {self.current_user}')
...
#     def approve_selected(self):
#         selected_ranges = self.approval_table.selectedRanges()
...
#                 user_id = int(self.approval_table.item(row, 0).text())
#                 approve_user(user_id)
#                 approved_count += 1
